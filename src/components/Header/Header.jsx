      ...
      <div className='container'>
        <nav className={s.nav}>
          ...
          <div className={`${s.menu} ${isMenu ? 'menu-open' : ''}`}>
            ...
            <Link onClick={menuHandle} className='link' href={'/'}>
              Главная
            </Link>
            <Link onClick={menuHandle} className='link' href={'/about'}>
              О нас
            </Link>
            <Link onClick={menuHandle} className='link' href={'/shop'}>
              Продукция
            </Link>
            <Link onClick={menuHandle} className='link' href={'/contacts'}>
              Контакты
            </Link>
            <Link onClick={menuHandle} className='link' href={'/tips'}>
            Советы по укладке
            </Link>
          </div>
